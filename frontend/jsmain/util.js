imgconfig = {'friend':{'base':"http://www.positiondial.com/userpic/",'default':baseimgurl+"img/friend.svg"},
			'visitor':{'base':"http://www.positiondial.com/userpic/",'default':baseimgurl+"img/friend.svg"},
			'authorstatement':{'base':baseimgurl+"authorimg/",'default':baseimgurl+"img/everyone.svg"},
			'authormp':{'base':baseimgurl+"authorimg/",'default':baseimgurl+"img/everyone.svg"},
			'author':{'base':baseimgurl+"authorimg/",'default':baseimgurl+"img/everyone.svg"},
			'authorppc':{'base':baseimgurl+"authorimg/",'default':baseimgurl+"img/everyone.svg"},
			'party':{'base':baseimgurl+"partyimg/",'default':baseimgurl+"img/everyone.svg"},
			'topic':{'base':baseimgurl+"img/",'default':baseimgurl+"img/white.png"},
			'org':{'base':baseimgurl+"orgimg/",'default':baseimgurl+"img/wallet.svg"},
			'visitoragg':{'base':baseimgurl+"authorimg/",'default':baseimgurl+"img/everyone.svg"},
      'campaign':{'base':baseimgurl+"authorimg/",'default':baseimgurl+"img/campaign.png"}
            };
...
function replacenewlines(s){
	return s.replace(/[\r\n]/gi, '<br/>').replace(/\s\s\s\s\s/g,'<br/>').trim();
}
