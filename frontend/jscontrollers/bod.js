...
pdapp.controller('bodCtrl', ["VisitorBodService",'$scope','$rootScope','$log','pdTopicService','ArticleService',
                                       function(visitorBodService, scope, rootScope, log, pdTopicService, articleService) {
	...
	scope.fetchLatestArticles = function (){
    	...
    	scope.itemcount = 0;
    	visitorBodService.query({"topic_id":scope.topic.id}, function(response){
